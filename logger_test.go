...
func ExampleNewLogger() {
	...
	Logger = NewLogger(WithName(`haha`), WithIsDebug(false), WithLevel(`info`), WithPrefix(`haha`))
	...
	// Output:
	// {"level":"info","ts":1585533316.645944,"caller":"go-logger/zap.go:63","msg":"hs6245wfdga111","message":"hs6245wfdga111","severity":"info"}
